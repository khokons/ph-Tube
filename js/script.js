const handleCategory = async () =>{
    ...
    trimData.forEach((category) => {
        ...
        div.innerHTML = `
         <a onclick="handleVideos('${category.category_id}')" class="text-black btn hover:bg-red-600">${category.category}</a> 
        `;
